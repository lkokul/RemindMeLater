...
db.exec(`
  ...
  -- su cuenta cual de estos temas mostrar (ver app_settings mas abajo),
  -- asi que guardar uno no fuerza a nada mas.
  ...
  -- Almacen generico clave/valor para ajustes de esta instalacion. De
  -- momento solo guardamos que tema tiene activo, pero sirve para
  -- cualquier ajuste futuro de ese tipo.
...
// seguro re-arrancar la app tanto en una base de datos nueva como
...
// email: se pide en la pantalla de bienvenida del primer arranque.
// Nacio ademas como contacto tecnico obligatorio del protocolo Web Push
// al mandar avisos al movil; eso ya no existe en la app de escritorio,
// asi que ahora mismo es solo un dato del perfil. Opcional a proposito.
...
// ---------------------------------------------------------------------
module.exports = db;
// DATA_DIR: mismo sitio donde vive la base de datos. Se reexporta aqui
// por comodidad para quien ya tiene el modulo db a mano; core/dataDir.js
// sigue siendo la unica fuente de verdad de donde vive esa carpeta.
