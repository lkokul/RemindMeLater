// viajesTrips — portado de server/routes/viajesTrips.js.
//
...
// Lo que en el servidor era un require('./viajesEntries') aqui es la
// global que publica ese archivo, asi que tiene que cargarse antes.
(function () {
  const db = localDb;
  ...
  // paises.
  const { deleteEntryCascade, touchEntryForAttachmentChange } = viajesEntriesLocalExports;
  ...
  mountLocalRouter('/api/viajes-trips', router);
})();
